...
export const V1ExecuteOperationsOperationEnum = {
  Delete: "Delete",
  Insert: "Insert",
  Select: "Select",
  Update: "Update",
...
export type V1ExecuteOperationsOperationEnum = typeof V1ExecuteOperationsOperationEnum[keyof typeof V1ExecuteOperationsOperationEnum];
...
export const V1MigrateOperationsOperationEnum = {
  Alter: "Alter",
  Create: "Create",
  Drop: "Drop"
} as const;

export type V1MigrateOperationsOperationEnum = typeof V1MigrateOperationsOperationEnum[keyof typeof V1MigrateOperationsOperationEnum];
export const V1MigrateOperationsResourceEnum = {
  Column: "Column",
...
export type V1MigrateOperationsResourceEnum = typeof V1MigrateOperationsResourceEnum[keyof typeof V1MigrateOperationsResourceEnum];
...
export const DefaultApiAxiosParamCreator = function (
  ...
  return {
    ...
    rawsql: async (
      ...
      assertParamExists("rawsql", "inlineObject4", inlineObject4);
...
export const DefaultApiFactory = function (
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    rawsql(inlineObject4: InlineObject4, options?: any): AxiosPromise<void> {
      return localVarFp
        .rawsql(inlineObject4, options)
        .then(request => request(axios, basePath));
    },
    /**
     *
     ...
     * @throws {RequiredError}
     */
    uploadFile(token: string, options?: any): AxiosPromise<InlineResponse2009> {
      return localVarFp
     ...
     * @throws {RequiredError}
     */
    v1VersionGet(options?: any): AxiosPromise<{ [key: string]: object }> {
      return localVarFp
...
export class DefaultApi extends BaseAPI {
   ...
   * @memberof DefaultApi
   */
  public rawsql(inlineObject4: InlineObject4, options?: AxiosRequestConfig) {
    return DefaultApiFp(this.configuration)
      .rawsql(inlineObject4, options)
      .then(request => request(this.axios, this.basePath));
  }
