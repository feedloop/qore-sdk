...
export interface GetSchema200Response {
  ...
  /**
   *
   * @type {Array<GetSchema200ResponseAuthProvidersInner>}
   * @memberof GetSchema200Response
   */
  authProviders?: Array<GetSchema200ResponseAuthProvidersInner>;
}
/**
 *
 * @export
 * @interface GetSchema200ResponseAuthProvidersInner
 */
export interface GetSchema200ResponseAuthProvidersInner {
  [key: string]: any;

  /**
   *
   * @type {string}
   * @memberof GetSchema200ResponseAuthProvidersInner
   */
  id?: string;
  /**
   *
...
export interface GetSchema200ResponseTablesInner {
  ...
  /**
   *
   * @type {Array<GetSchema200ResponseTablesInnerIndexesInner>}
   * @memberof GetSchema200ResponseTablesInner
   */
  indexes: Array<GetSchema200ResponseTablesInnerIndexesInner>;
  /**
   *
   * @type {string}
   * @memberof GetSchema200ResponseTablesInner
 ...
 *
 * @export
 * @interface GetSchema200ResponseTablesInnerIndexesInner
 */
export interface GetSchema200ResponseTablesInnerIndexesInner {
  /**
   *
   * @type {string}
   * @memberof GetSchema200ResponseTablesInnerIndexesInner
   */
  name: string;
  /**
   *
  ...
  /**
   *
   * @type {Array<GetSchema200ResponseTablesInnerIndexesInnerColumnsInner>}
   * @memberof GetSchema200ResponseTablesInnerIndexesInner
   */
  columns: Array<GetSchema200ResponseTablesInnerIndexesInnerColumnsInner>;
}
/**
 *
 * @export
 * @interface GetSchema200ResponseTablesInnerIndexesInnerColumnsInner
 */
export interface GetSchema200ResponseTablesInnerIndexesInnerColumnsInner {
  /**
   *
   * @type {string}
   * @memberof GetSchema200ResponseTablesInnerIndexesInnerColumnsInner
   */
  name?: string;
}
/**
 ...
 *
 * @export
 * @interface LinkAccount200Response
 */
export interface LinkAccount200Response {
  /**
   *
   * @type {string}
   * @memberof LinkAccount200Response
   */
  message: string;
}
/**
...
export interface SubmitPasswordRequest {
   ...
   *
   * @type {string}
   * @memberof SubmitPasswordRequest
   */
  newPassword: string;
}
/**
...
export const DefaultApiAxiosParamCreator = function (
  ...
  return {
    ...
    callbackProvider: async (
      ...
      assertParamExists("callbackProvider", "code", code);
      // verify required parameter 'state' is not null or undefined
      assertParamExists("callbackProvider", "state", state);
      // verify required parameter 'provider' is not null or undefined
      assertParamExists("callbackProvider", "provider", provider);
      const localVarPath = `/v1/login/{provider}/callback`.replace(
        `{${"provider"}}`,
    ...
    /**
     *
     * @param {string} targetAccountToken
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     */
    linkAccount: async (
      ...
      // verify required parameter 'targetAccountToken' is not null or undefined
      assertParamExists(
        "linkAccount",
        "targetAccountToken",
        targetAccountToken
      ...
      if (targetAccountToken !== undefined) {
        localVarQueryParameter["target_account_token"] = targetAccountToken;
      }
    ...
    loginProvider: async (
      ...
      assertParamExists("loginProvider", "callback", callback);
      // verify required parameter 'provider' is not null or undefined
      assertParamExists("loginProvider", "provider", provider);
      const localVarPath = `/v1/login/{provider}`.replace(
        `{${"provider"}}`,
        encodeURIComponent(String(provider))
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
    ...
    recovery: async (
      ...
      // verify required parameter 'recoveryRequest' is not null or undefined
      assertParamExists("recovery", "recoveryRequest", recoveryRequest);
      const localVarPath = `/v1/auth/recovery`;
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
      const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
      let baseOptions;
      if (configuration) {
    ...
    storageFile: async (
      ...
      // verify required parameter 'token' is not null or undefined
      assertParamExists("storageFile", "token", token);
      // verify required parameter 'table' is not null or undefined
      assertParamExists("storageFile", "table", table);
      // verify required parameter 'column' is not null or undefined
      assertParamExists("storageFile", "column", column);
      // verify required parameter 'rowId' is not null or undefined
      assertParamExists("storageFile", "rowId", rowId);
      // verify required parameter 'filename' is not null or undefined
      assertParamExists("storageFile", "filename", filename);
      const localVarPath = `/v1/storage/files/{table}/{rowId}/{column}/{filename}`
        .replace(`{${"table"}}`, encodeURIComponent(String(table)))
        .replace(`{${"column"}}`, encodeURIComponent(String(column)))
        .replace(`{${"rowId"}}`, encodeURIComponent(String(rowId)))
        .replace(`{${"filename"}}`, encodeURIComponent(String(filename)));
    ...
    storageToken: async (
      ...
      const localVarPath = `/v1/storage/token`;
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
      const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
      let baseOptions;
      if (configuration) {
     ...
     *
     * @param {string} token
     * @param {SubmitPasswordRequest} submitPasswordRequest
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     */
    submitPassword: async (
      ...
      // verify required parameter 'token' is not null or undefined
      assertParamExists("submitPassword", "token", token);
      // verify required parameter 'submitPasswordRequest' is not null or undefined
      assertParamExists(
        "submitPassword",
        "submitPasswordRequest",
        submitPasswordRequest
      );
      const localVarPath = `/v1/auth/recovery/submit`;
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
      const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
      let baseOptions;
      if (configuration) {
...
export const DefaultApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    async authenticateGet(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.authenticateGet(
        options
      );
      return createRequestFunction(
        localVarAxiosArgs,
    ...
    async callbackProvider(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.callbackProvider(
        code,
        state,
        provider,
        options
    ...
    async linkAccount(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string
      ) => AxiosPromise<LinkAccount200Response>
    > {
    ...
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.loginProvider(
        callback,
        provider,
        options
      );
    ...
    async storageFile(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.storageFile(
        token,
        table,
        column,
        rowId,
    ...
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.storageToken(
        options
      );
      return createRequestFunction(
        localVarAxiosArgs,
    ...
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.submitPassword(
        token,
        submitPasswordRequest,
        options
      );
    ...
    async v1EnvGet(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.v1EnvGet(
        options
      );
      return createRequestFunction(
        localVarAxiosArgs,
...
export const DefaultApiFactory = function (
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    authenticateGet(options?: any): AxiosPromise<void> {
      return localVarFp
        .authenticateGet(options)
        .then(request => request(axios, basePath));
    },
    /**
     *
    ...
    callbackProvider(
      ...
      return localVarFp
        .callbackProvider(code, state, provider, options)
        .then(request => request(axios, basePath));
    },
    /**
     *
    ...
    linkAccount(
      ...
      return localVarFp
        .linkAccount(targetAccountToken, options)
        .then(request => request(axios, basePath));
    },
    /**
     *
    ...
    loginProvider(
      ...
      return localVarFp
        .loginProvider(callback, provider, options)
        .then(request => request(axios, basePath));
    },
    /**
     *
    ...
    recovery(
      ...
      return localVarFp
        .recovery(recoveryRequest, redirect, options)
        .then(request => request(axios, basePath));
    },
    /**
     *
    ...
    storageFile(
      ...
      return localVarFp
        .storageFile(token, table, column, rowId, filename, options)
        .then(request => request(axios, basePath));
    },
    /**
     *
     ...
     * @throws {RequiredError}
     */
    storageToken(options?: any): AxiosPromise<Authorize200Response> {
      return localVarFp
        .storageToken(options)
        .then(request => request(axios, basePath));
    },
    /**
     *
    ...
    submitPassword(
      ...
      return localVarFp
        .submitPassword(token, submitPasswordRequest, options)
        .then(request => request(axios, basePath));
    },
    /**
     *
     ...
     * @throws {RequiredError}
     */
    v1EnvGet(options?: any): AxiosPromise<void> {
      return localVarFp
        .v1EnvGet(options)
        .then(request => request(axios, basePath));
    },
...
export class DefaultApi extends BaseAPI {
   ...
   * @memberof DefaultApi
   */
  public authenticateGet(options?: AxiosRequestConfig) {
    return DefaultApiFp(this.configuration)
      .authenticateGet(options)
      .then(request => request(this.axios, this.basePath));
  }
   ...
   * @memberof DefaultApi
   */
  public linkAccount(targetAccountToken: string, options?: AxiosRequestConfig) {
    return DefaultApiFp(this.configuration)
      .linkAccount(targetAccountToken, options)
      .then(request => request(this.axios, this.basePath));
  }
   ...
   * @memberof DefaultApi
   */
  public storageToken(options?: AxiosRequestConfig) {
    return DefaultApiFp(this.configuration)
      .storageToken(options)
      .then(request => request(this.axios, this.basePath));
  }
   ...
   * @memberof DefaultApi
   */
  public v1EnvGet(options?: AxiosRequestConfig) {
    return DefaultApiFp(this.configuration)
      .v1EnvGet(options)
      .then(request => request(this.axios, this.basePath));
  }
