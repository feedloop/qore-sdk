...
export interface Execute200Response {
   ...
   */
  results: { [key: string]: Array<{ [key: string]: any }> };
}
/**
 *
 * @export
...
export interface GetRows200Response {
  ...
  /**
   *
   * @type {GetRows200ResponsePagination}
   * @memberof GetRows200Response
   */
  pagination: GetRows200ResponsePagination;
}
/**
 *
 * @export
 * @interface GetRows200ResponsePagination
 */
export interface GetRows200ResponsePagination {
  /**
   *
   * @type {number}
   * @memberof GetRows200ResponsePagination
   */
  page: number;
  /**
   *
 ...
 * Unauthorized
 * @export
 * @interface GetRows401Response
 */
export interface GetRows401Response {
  /**
   *
   * @type {number}
   * @memberof GetRows401Response
   */
  statusCode: number;
  /**
   *
...
export const DefaultApiAxiosParamCreator = function (
  ...
  return {
    ...
    uploadFile_2: async (
      ...
      // verify required parameter 'token' is not null or undefined
      assertParamExists("uploadFile_2", "token", token);
...
export const DefaultApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.uploadFile_2(
        token,
        options
      );
      return createRequestFunction(
...
export class DefaultApi extends BaseAPI {
   ...
   * @memberof DefaultApi
   */
  public uploadFile_2(token: string, options?: AxiosRequestConfig) {
    return DefaultApiFp(this.configuration)
      .uploadFile_2(token, options)
      .then(request => request(this.axios, this.basePath));
  }
