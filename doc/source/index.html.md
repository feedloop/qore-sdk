...
Install @qore/cli globally via npm or yarn.
...
```shell
npm install @qore/client
```

> Installing via yarn

```shell
yarn add @qore/client
```

Install @qore/client on your project, you may want to skip this section if you have a starter-kit project already.

> Optional: Install @qore/react to your project.
...
```jsx
import createQoreContext from "@qore/react";
import config from "./qore.config.json";
