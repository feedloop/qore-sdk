...
But wait, what is `qore.config.json`? what about `qore.schema.json`?

Relax, to get those files all you need to do is running `$ qore codegen` on your root project directory. Jump to [Codegen](#codegen) section for more information.
...
Yes, `qore-generated.ts` is generated by the [codegen](#codegen) as well.
