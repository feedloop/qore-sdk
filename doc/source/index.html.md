...
Install @feedloop/qore-client on your project.

<aside class="success">
You may want to skip this section if your project is created from our template.
</aside>
...
## Initializing qore client

Initialize qore client with the config generated by the codegen.

<aside class="success">
If you generate a new project from template, initialization should be done already on `[your-project-root]/utils/qoreContext.ts`.
</aside>
...
Navigate to your project from your terminal, install the dependencies then hit `$ yarn dev` to start your project.

<p>
<script id="asciicast-382477" src="https://asciinema.org/a/382477.js" async></script>
</p>

Open this url from your browser and start exploring `http://localhost:3000`.

<p>
<iframe src="https://drive.google.com/file/d/13tJRp-tBsDF6nScK-sqxK-XmNXANMR0E/preview" width="640" height="480"></iframe>
</p>
