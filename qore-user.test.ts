...
describe('Qore User', () => {
    describe('Public', () => {
        it('should register new user', async () => {
            ...
            await expectAsync(client.register({
                "name": "rama",
                "email": "gg@gg.co",
                "password": "xxx"
            })).toBeResolved()
    ...
    describe('Logged in', () => {
        describe('Organization', () => {
            it('should create new organization', async () => {
                const client = QoreUser()
                await expectAsync(client.login(mockUsername, mockPw)).toBeResolved()
                expectAsync(client.createOrganization({
                    "name": "feedloop",
                    "category": "telco",
                    "size": "10-50"
